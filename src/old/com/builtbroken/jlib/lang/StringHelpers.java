...
public final class StringHelpers {
	...
	/**
	 * Breaks nano second time long into seconds, miliseconds, microseconds, and nanosecond sections making it easier to
	 * read.
	 *
	...
	/**
	 * Converts a throwable to a simple string output for usage in displays and other basic outputs.
	 *
	 * @param t - throwable
	 * @return String
	 */
