...
public class MissileChunkEvent extends Event {
	...
	/**
	 * Called when a missile is about to load a chunk. Use this to change the amount of time the cunk should be loaded
	 * for, or cancel this event to not load the chunk.
	 */
	@Cancelable
	...
	/**
	 * Called when a chunk loaded by a missile is about to be unloaded. Cancel this event to not unload the chunk. Make
	 * sure to change the time the chunk should be loaded for or another attempt to unload the chunk will be made in the
	 * next world tick.
	 */
	@Cancelable
