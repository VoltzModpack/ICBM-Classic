 ...
 * <p>
 * Keep in mind this may not be directly on the calling block. It may be wrapped to the host block. Especially in the
 * case of multi-block such as the launcher base.
 * <p>
 * In theory this should just be a wrapper to the inventory. However, it may do additional checks to ensure the missile
 * is supported Created by Dark(DarkGuardsman, Robert) on 1/9/19.
 */
public interface IMissileHolder {
	 ...
	 * <p>
	 * Does not validate the stack and will override any checks
	 *
	 * @param stack
	 */
