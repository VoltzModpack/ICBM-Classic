...
public interface IExMissileRegistry extends IExplosiveContentRegistry {
	 ...
	 * <p>
	 * * Do not use this in place of normal events, this is designed to add logic for * specific missile types.
	 *
	...
	/**
	 * Adds a simple callback for player interaction with missile. This should be used to encoded data into the missile.
	 * Such as setting teleportation coordinates in the same way the ender blast does.
	 * <p>
	 * Do not use this in place of normal events, this is designed to add logic for specific missile types.
	 *
	 * @param exName   - id of the explosive/missile
