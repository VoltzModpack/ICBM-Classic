...
public interface IExplosiveContentRegistry {
	...
	/**
	 * Creates a new explosive device represented by this registry.
	 * <p>
	 * Ex: Missile stack
	 * <p>
	 * Note each registry should only have 1 item mapped to it as a time. If another item is desired then a registry
	 * should be created to mirror the previous registry.
	 *
	 * @param regName - registry name of the explosive
	...
	/**
	 * Called at the end of registry phase to lock the registry, convert lists to immutable, and prevent late
