...
public interface IRadioWaveReceiver extends IWorldPosition {
	 ...
	 *
	 * @param hz            - frequency the message is on, ignore if this receive is tuned to a set frequency.
	...
	/**
	 * Gets the range of the receive as a cube. The range should be equal to the size of the antenna. As a receiver can
	 * not pick up a signal outside of its body area.
	 * <p>
	 * <p>
	 * Keep in mind a receiver is a passive object and has a constant range. Use the distance from the sender to gauge
	 * strength of signal. Then boost the strength using logic rather than increasing range using power boosting.
	 *
	 * @return cube
	 */
