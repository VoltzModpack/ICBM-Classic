...
public interface IBlastInit extends IBlast {
	...
	/**
	 * Called to set the source of the blast. Only call on init of the blast.
	 *
	...
	/**
	 * Called to set the world of the blast. Only call on init of the blast. The world should never change for a blast.
	 * If you teleport the blast through a portal destroy and recreate to kill connections.
	 *
	 * @param world
	 * @return this
	 */
	...
	/**
	 * Sets the blast's position. Should only be called on init of the blast. Use separate methods to move or teleport
	 * the blast.
	 *
	 * @param x
	 * @param y
	...
	/**
	 * Sets the custom data to change properties of the blast not part of the normal blast chain of calls.
	 *
	 ...
	 * <p>
	 * This is called after {@link #buildBlast()} so do not lock after the blast is built. As controller may need to
	 * refresh or change dimensions.
	 *
	...
	/**
	 * Called last to complete the build of the blast. Once called all methods in this interface should ignore changes.
	 *
	 * @return this
	 */
