...
public interface IBlast extends IWorldPosition {
	...
	/**
	 * Gets the radius size of the effect of the blast. This not always the full effect range of the blast. Rather is
	 * used more as a scale factor
	 *
	...
	/**
	 * Is the blast completed and can be marked as dead.
	 *
	...
	/**
	 * Data used to create the blast. Used for save state recovery
	 *
	 * @return
	 */
	@Nullable
	 ...
	 * <p>
	 * Not all blasts have an entity that handles updates. Some are controlled by the thread system and others are fired
	 * as simple TNT like explosives
	 *
	 * @return controller
	 */
	@Nullable
	...
	/**
	 * Called to clear the blast from the world. This should only be used by server utilities and commands.
	 */
	void clearBlast();
