...
public class MissileTrackerHandler {
	 ...
	 * <p>
	 * This will destroy the missile and load it's data into the simulate. Which will then tick down until the missile
	 * should be spawned again.
	 *
	 ...
	 * <p>
	 * Will load the handler if save data exists in the world. If not it will create a new handler for use. May return
	 * NULL if create is false and the handler was not found!
	 *
