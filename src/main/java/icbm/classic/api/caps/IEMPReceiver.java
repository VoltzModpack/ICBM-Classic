...
/**
 * Applied to an object as a capability (Item/Entity/TileEntity) or registered to {@link
 * icbm.classic.api.ICBMClassicAPI#registerBlockEmpHandler(net.minecraft.block.Block, IEMPReceiver)} to receiver EMP
 * effects from a EMP blast or similiar system.
 * <p>
 * <p>
...
public interface IEMPReceiver {
	 ...
	 * @param power     - arbitrary value between 0 and 1 noting the power of the blast. Can be greater than 1 to note
	 *                  overpowered blast. Though will rarely have any effect on most actions other than to bypass
	 *                  shielding.
	...
	/**
	 * Sub version of {@link #applyEmpAction(World, double, double, double, IBlast, float, boolean)} used in connection
	 * with objects that are contained inside other objects. Allows gaining access to parent object in case addition
	...
	/**
	 * Called to get a theoretical resistance value for the object. Mainly will be used for simulation code and display
	 * of data to the user.
	 *
	 * @param world - this object's world
	 * @param x     - this object's x position
	...
	/**
	 * Called to check if the theoretical resistance value for the object is flat or ratio based. Mainly will be used
	 * for simulation code and display of data to the user.
	 *
	 * @param world - this object's world
	 * @param x     - this object's x position
	 * @param y     - this object's y position
