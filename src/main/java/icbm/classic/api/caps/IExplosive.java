...
/**
 * Used in capabilities to provide an explosive for usage Created by Dark(DarkGuardsman, Robert) on 1/7/19.
 */
public interface IExplosive {
	...
	/**
	 * Gets the custom NBT data to encode into any blast created from the explosive
	 *
	 * @return nbt
	 */
	@Nullable
