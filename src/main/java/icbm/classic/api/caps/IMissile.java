...
public interface IMissile extends IWorldPosition {
	 ...
	 *
	 * @param fullExplosion - True will trigger a the missile's normal explosion False will trigger a TNT explosion
	 */
	...
	/**
	 * The amount of ticks this missile has been flying for. Returns -1 if the missile is not flying.
	 */
	 ...
	 * @param y          - target
	 * @param z          - target
	 * @param lockHeight - height to above current to wait before turning towards target TODO change to distance for
	 *                   flat xz paths
	 */
