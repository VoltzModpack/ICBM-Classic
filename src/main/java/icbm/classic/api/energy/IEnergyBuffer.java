...
/**
 * Simple interface applied to objects that store energy. Normally when exposing this to other object to use the energy
 * is expressed in VE joules. If you are storing in another type then convert before returning. Created by Dark on
 * 8/15/2015.
 */
public interface IEnergyBuffer //TODO see if we should keep this or go full ForgeEnergy
{
	 ...
	 * <p>
	 * Do not use this add or remove energy. Instead, use {@link #addEnergyToStorage(int, boolean)} and {@link
	 * #removeEnergyFromStorage(int, boolean)} in order to trigger actions and events correctly.
	 * <p>
	 * This method is only added for edge cases such as packet handling and EMPs.
	 *
