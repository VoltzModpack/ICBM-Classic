...
public interface IWorldPosItem {
	...
	/**
	 * Retrieves the location from the NBT, Creates a new object each method call
	 *
	...
	/**
	 * Used by the item to prevent access directly to the stored data. Designed to prevent tiles from direct access to
	 * data.
	 *
