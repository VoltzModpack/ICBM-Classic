...
public abstract class EmpEvent extends BlastEvent {
	 ...
	 * <p>
	 * Canceling the effect will remove any side effects that are normally applied. This includes mutating some
	 * entities, apply some effects, and adding EMP effects to items.
	 */
	@Cancelable
	...
	/**
	 * Called after EMP effects have been applied to the entity. This includes several different effects and EMP effects
	 * on items.
	 */
	...
	public static class BlockPre extends EmpEvent {
		...
		public BlockPre(IBlast emp, World world, BlockPos pos, BlockState state) {
			super(emp);
			this.world = world;
			this.blockPos = pos;
			this.state = state;
	...
	public static class BlockPost extends EmpEvent {
		...
		public BlockPost(IBlast emp, World world, BlockPos pos, BlockState state) {
			super(emp);
			this.world = world;
			this.blockPos = pos;
			this.state = state;
