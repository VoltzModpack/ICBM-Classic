...
public class ExplosiveDefuseEvent extends Event {
	...
	/**
	 * Called when a player leftclicks an ICBM explosive. Cancel to not defuse the explosive.
	 */
	@Cancelable
	...
	/**
	 * Called when a player leftclicks a vanilla TNT block, or potential derivates of other mods. Cancel to not defuse
	 * the tnt.
	 */
	@Cancelable
	...
	/**
	 * Called when a player leftclicks an ICBM bomb cart. Cancel to not defuse the bomb cart.
	 */
	@Cancelable
