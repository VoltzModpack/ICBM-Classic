...
public class MissileRideEvent extends Event {
	...
	/**
	 * Called right before a player starts to ride a missile. Cancel this event to disallow the player to ride the
	 * missile.
	 */
	@Cancelable
	...
	/**
	 * Called right before a player stops to ride a missile. Cancel this event to disallow the player to dismount the
	 * missile.
	 */
	@Cancelable
