...
public interface IMultiTile {
	...
	/**
	 * Sets the host for this multi block peace. Should never be called by anything other than the multi block host
	 *
	 * @param host
	 */
	...
	/**
	 * Allows custom checks to see if the tile is the host. Can be used to chain multi-blocks or adapt the check to use
	 * position rather than instanceof.
	 *
	 * @param host
	 * @return
	 */
