...
/**
 * Implemented by blocks that act as the host or logical brain for a multiblock structure Created by Dark on 8/9/2015.
 */
...
public interface IMultiTileHost extends IWorldPosition {
	...
	/**
	 * Called when a tile has been invalidated. Most likely this is called when a chunk is unloaded from the world.
	 *
