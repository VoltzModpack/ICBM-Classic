...
public interface IRadioWaveSender extends IWorldPosition {
	...
	/**
	 * Confirmation that the wave was received, only used for code logic.
	 * <p>
	 * In no way is this a mirror of how radio waves work in real life. In other words just use this to confirm logic.
	 * Use {@link IRadioWaveReceiver} to actually handle real confirmation messages.
	 *
	 * @param receiver - object that recieved the message, this will be called several times for each tower the recieves
	 *                 the message
	...
	/**
	 * Either called internally or by an external machine to send a message threw this device.
	 * <p>
	 * If external, ensure there is a valid connection with the machine.
	 *
	...
	/**
	 * Gets the range of the sender as a cube.
	 * <p>
	 * Range should be based on size of the antenna and power of the sending unit.
	 *
	 * @return cube
	 */
