...
/**
 * Applied to blasts that exist in world and tick Created by Dark(DarkGuardsman, Robert) on 2/10/2019.
 */
public interface IBlastTickable extends IBlast {
	...
	/**
	 * Should the tickable blast be controlled by an explosive entity
	 *
	 * @return
	 */
