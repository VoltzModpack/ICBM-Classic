...
public class Cube extends Shape3D implements Cloneable, IByteBufWriter {
	 ...
	 *
	 * @return list of coords using cube bounds for an example of usage.
	 */
	...
	/**
	 * Called after the cube's data has changed in order to update any internal data.
	 */
	...
	/**
	 * Mainly used by the selection render to see if camera is close enough to the bounds to render. Mainly checks for
	 * distance to corner, center, and is in side bounds.
	 *
