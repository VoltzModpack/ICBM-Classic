 ...
 * variables for rotation. Thus it will also be setup to allow adjustments to rotation.
 * <p>
 * <p>
...
public class EulerAngle implements Cloneable, ITransform, IByteBufWriter, IByteBufReader, IRotation {
	...
	/**
	 * Sets the value of the index angle to the value provided Legacy code
	 *
	 ...
	 * @param error - room for error in degrees, amount that the current yaw can move by to be at the desired yaw. If
	 *              error is <b>negative</b> this will always return false
	 ...
	 * @param error - room for error in degrees, amount that the current pitch can move by to be at the desired pitch.
	 *              If error is <b>negative</b> this will always return false
	 ...
	 * @param error - room for error in degrees, amount that the current roll can move by to be at the desired roll. If
	 *              error is <b>negative</b> this will always return false
	...
	/**
	 * Converts object into an array of doubles(yaw, pitch, roll). More or less legacy code...
	 *
	 * @return 3 size array
	 */
	 ...
	 * @param deltaTime - time difference to move, used for lerp function. Use one if you do not care to use lerp.
	 * @return this
	 */
	 ...
	 * @param movement - amount to move if delta is less the movement it will snap if zero or less it will return
	 *                 current
	 * @return this
	 */
	...
	/**
	 * Is the angle near zero zero zero. Does not check for exact as 0.00001 != 0.00000
	 *
	...
	/**
	 * Is the angle near zero. Does not check for exact as 0.00001 != 0.00000
	 *
	 * @return true if values are near zero
	 */
