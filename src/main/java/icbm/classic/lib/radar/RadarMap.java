...
/**
 * System designed to track moving or stationary targets on a 2D map. Can be used to detect objects or visualize objects
 * in an area. Mainly used to track flying objects that are outside of the map bounds(Missile in ICBM).
 * <p>
 * <p>
...
public class RadarMap {
	...
	/**
	 * Called at the end of every world tick to do checks on data stored.
	 */
	public void update() {
