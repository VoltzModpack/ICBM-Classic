...
/**
 * Used with IExternalInventory to move the inventory functionality outside of the tile class. Designed to make it
 * easier to abstract inventory functionality. Though for ISidedInventory it still requires the methods to be present in
 * the tile. Though this can easily be achieved with compile time injection of methods, asm, copy/paste, or scala
 * traits.
 *
