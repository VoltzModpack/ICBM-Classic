...
/**
 * Applied to objects that are used as inventory implementation external from the core object.
 *
...
public interface IExternalInventory extends IInventory {
	 ...
	 * <p>
	 * If you use VoltzEngine as a hard dep just wrapper this to (@link InventoryUtility#getFilledSlots(IInventory)}
	 *
