...
public class ItemBlockAbstract extends BlockItem {
	...
	/**
	 * Gets the detailed information for the item shown after the global generic item details.
	 *
	 * @param stack
	 * @param player
	 * @param list
	...
	/**
	 * Gets the detailed when shift is held information for the item shown after the global generic item details.
	 * <p>
	...
	/**
	 * Does the item have detailed information to be shown when shift is held
	 *
	 * @param stack
	 * @param player
	 * @return
