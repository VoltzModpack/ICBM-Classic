...
public abstract class EntityProjectile extends EntityICBM implements IProjectile {
	...
	/**
	 * The entity who shot this projectile and can be used for damage calculations As well useful for causing argo on
	 * the shooter
	 */
	...
	/**
	 * Location the projectile was fired from, use this over the shooting entity to force argo on the source of the
	 * projectile. This way things like zombies don't auto go to players. Instead they can move towards the firing
	...
	/**
	 * Called to see if collision checks should be ignored on the entity.
	 *
	 * @param entity
	...
	/**
	 * Called when the projectile impacts a tile. Data about the hit is stored in the entity include location, block,
	 * and meta
	 *
